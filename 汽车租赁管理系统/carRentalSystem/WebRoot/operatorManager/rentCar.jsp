	...
	<script type="text/javascript">
		function subForm(){
			...
			if(obj != null && obj != ""){
				...
				window.location = "<%=basePath%>custManager/addCustomers.jsp";
			}
		}
	</script>
  </head>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
  ...
  <body>
   <form action="PreCreateRentCarTable.do" method="post">
   <h5><font color="red">${requestScope.msg }</font></h5>
<table class="maintable" border="0" width="100%" cellspacing="0">
	<tr>
		<td width="22%" class="searchfontlist">
		<div align="right">客户身份证号：</div></td>
		<td width="19%">
		<div align="left">
		  <input type="text" name="identity" id="identity" /></div></td>
		<td width="13%"><div align="center"><img  src="<%=basePath%>images/carimg/continue.gif" onclick="subForm()" style="cursor: hand;"></div></td>
		<td width="46%"></td>
	</tr>
</table>
</form>
