...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
  ...
  <body>
     <form  action="UpdateCheckTable.do" method="post">
	...
	<tr>
		...
		<td width="13%"><input type="text" name="checkId" id="checkId" value="${requestScope.ck.checkId}"></td>
		<td width="14%">&nbsp;</td>
		<td width="14%">&nbsp;</td>
		<td width="20%">
		  <div align="center">检查时间：</div></td>
		<td width="27%">${requestScope.ck.checkDate}</td>
	</tr>
	<tr>
		<td width="12%" height="27">
	    <div align="center">属性：</div></td>
		<td width="13%"><input type="text" name="field" id="field" value="${requestScope.ck.field }"></td>
		<td width="14%">&nbsp;</td>
		<td width="14%">&nbsp;</td>
		<td width="20%">
		 <div align="center">检查员：</div></td>
		<td width="27%">${requestScope.ck.user.userName }</td>
	</tr>
	<tr>
		<td width="12%" height="27">
	    <div align="center">问题：</div>		</td>
		<td width="13%"><input type="text" name="problem" id="problem" value="${requestScope.ck.problem }"></td>
		<td width="14%">&nbsp;</td>
		<td width="14%">&nbsp;</td>
		<td width="20%">
		  <div align="center">赔费：</div></td>
		<td width="27%"><input type="text" name="paying" id="paying" value="${requestScope.ck.paying }"></td>
	</tr>
	<tr>
